...
#define FL_UART_BAUD(baud) (uint16_t)(((FOSC*PLL_M/VPBDIV_VAL) / ((baud) * 16.0)) + 0.5)

///////////////////////////////////////////////////////////////////////////////
// Definitions for typical UART 'baud' settings
#define B1200         FL_UART_BAUD(1200)
#define B2400         FL_UART_BAUD(2400)
#define B4800         FL_UART_BAUD(4800)
#define B9600         FL_UART_BAUD(9600)
#define B19200        FL_UART_BAUD(19200)
#define B38400        FL_UART_BAUD(38400)
#define B57600        FL_UART_BAUD(57600)
#define B115200       FL_UART_BAUD(115200)
#define B230400       FL_UART_BAUD(230400)
#define B460800       FL_UART_BAUD(460800)
#define B921600       FL_UART_BAUD(921600)
#define B1843200      FL_UART_BAUD(1843200)
#define B3686400      FL_UART_BAUD(3686400)
...
inline void uart1_set_rts( void );
inline void uart1_clear_rts( void );
inline int uart1_cts( void );
