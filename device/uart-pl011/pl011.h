...
struct uart_csreg
{
    volatile uint32_t buffer;      /**< PL011 DR                           */ //0x00
    volatile uint32_t rsrecr;      /**< PL011 RSRECR                       */ //0x04
    volatile uint32_t dont_use_a;  /** spacer                              */ //0x08
    volatile uint32_t dont_use_b;  /** spacer                              */ //0x0C
    volatile uint32_t dont_use_c;  /** spacer                              */ //0x10
    volatile uint32_t dont_use_d;  /** spacer                              */ //0x14
    volatile uint32_t fr;          /**< PL011 FR                           */ //0x18
    volatile uint32_t dont_use_e;  /** spacer                              */ //0x1C
    volatile uint32_t ilpr;        /**< PL011 ILPR                         */ //0x20
    volatile uint32_t ibrd;        /**< PL011 IBRD                         */ //0x24
    volatile uint32_t fbrd;        /**< PL011 FBRD                         */ //0x28
    volatile uint32_t lcrh;        /**< PL011 LCRH                         */ //0x2C
    volatile uint32_t cr;          /**< PL011 CR                           */ //0x30
    volatile uint32_t ifls;        /**< PL011 IFLS                         */ //0x34
    volatile uint32_t imsc;        /**< PL011 IMSC                         */ //0x38
    volatile uint32_t ris;         /**< PL011 RIS                          */ //0x3C
    volatile uint32_t mis;         /**< PL011 MIS                          */ //0x40
    volatile uint32_t icr;         /**< PL011 ICR                          */ //0x44
};

/* Alternative names for control and status registers                   */
#define dr buffer               /**< data register                      */
