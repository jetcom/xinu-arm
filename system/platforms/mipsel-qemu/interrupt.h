 ...
 * processing.
 *
 * $Id: interrupt.h 2157 2010-01-19 00:40:07Z brylow $
 */
...
#define register_irq(irq, handler) (interruptVector[irq] = handler)
#define get_irq(irq) (interruptVector[irq])
void exlreset(void);
void exlset(void);
